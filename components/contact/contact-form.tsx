...
export function ContactForm() {
  ...
  return (
    <form
      action={formAction}
      className="space-y-6 rounded-2xl border border-black/10 bg-white p-8"
      ref={formRef}
    >
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <label className="block text-sm font-medium" htmlFor="contact-name">
          ...
          <input
            autoComplete="name"
            className="mt-2 w-full rounded-xl border border-black/20 bg-white px-3 py-3 font-normal"
            id="contact-name"
            name="name"
            required
          />
      ...
      <label className="block text-sm font-medium" htmlFor="contact-message">
        Message
        <textarea
          className="mt-2 min-h-48 w-full rounded-xl border border-black/20 bg-white px-3 py-3 font-normal"
          id="contact-message"
          maxLength={5000}
          minLength={10}
          name="message"
